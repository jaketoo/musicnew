...
GAME_BUTTONS = [
    [ 
        ...
        InlineKeyboardButton ('⌞ ᥉᥆υᖇᥴᥱ 𝙹𝙰𝙺𝙾𝙾⌝', url =f"https://t.me/mvhmed")              
                 ],[
          ...
          if CallbackQuery.data == "GAME1":
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('🕷¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('لعبة البنك', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞ ᥉᥆υᖇᥴᥱ 𝙹𝙰𝙺𝙾𝙾⌝', url =f"https://t.me/mvhmed")              
                 ],[
                InlineKeyboardButton(
...
════════ ××× ════════ٴ"""
               SORGAM_BUTTON = [
                    [ 
                      InlineKeyboardButton ('⌞ ᥉᥆υᖇᥴᥱ 𝙹𝙰𝙺𝙾𝙾⌝', url =f"https://t.me/Mvhme")
                      ],[
